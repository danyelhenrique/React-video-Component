...
import { largeWidthVideo } from "../../../store/actions/largeVideo";
import "./index.css";
...
function Video(props) {
  ...
  const classLargeVideo = !!props.width.isLarge ? "large" : "";
  return (
...
const dispatchToProps = dispatch =>
  bindActionCreators({ largeWidthVideo }, dispatch);
